const settings = {
    skipIntro: {
        id: 'skip_intro',
        defaultValue: null,
        getCourseOption: function (courseId) {
            return localStorage.getItem(`${courseId}_${this.id}`) || this.defaultValue;
        },
        setCourseOption: function (courseId, value) {
            localStorage.setItem(`${courseId}_${this.id}`, value);
        },
    },
    darkMode: {
        id: 'dark_mode',
        defaultValue: false,
        apply: function () {
            let isDarkMode = this.getGlobalOption();
            if (isDarkMode) {
        ...
        getGlobalOption: function () {
            return localStorage.getItem(this.id) === 'true' || this.defaultValue;
        },
        setGlobalOption: function (value) {
            localStorage.setItem(this.id, value);
        },
        addDarkModeButton: addDarkModeButton
    },
};
